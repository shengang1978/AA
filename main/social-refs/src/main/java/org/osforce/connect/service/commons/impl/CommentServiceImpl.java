...
public class CommentServiceImpl implements CommentService {
	...
	public List<Comment> getCommentList(Long linkedId, String entity) {
		return commentDao.findCommentLIst(linkedId, entity);
	}
	
	public Long countComment(Long linkedId, String entity) {
		return commentDao.countComments(linkedId, entity);
	}

	public List<Comment> getCommentList(Long linkedId) {
		
		return commentDao.findCommentLIst(linkedId);
	}
}
