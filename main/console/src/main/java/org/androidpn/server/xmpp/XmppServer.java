...
public class XmppServer {
    ...
    public void start() {
        try {
            ...
            String cfgPath = "classpath:spring-config.xml";
            context = new ClassPathXmlApplicationContext(cfgPath); //ConfigManager.getInstance().getConfPath() + "/spring-config.xml");
...
//            log.info("Androidpn Server v" + version);
    ...
    private void locateServer() throws FileNotFoundException {
        String baseDir = getClass().getResource("/").getFile(); //System.getProperty("base.dir", "..");
