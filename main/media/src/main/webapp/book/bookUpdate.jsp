...
<body onload="boduOnload();">
<form action="<%=path%>/book/bookUpdate.do" method="post">
	...
	<div>
		<span>描述</span>
		<input type="text" name="desc" value="${media.desc}">
	</div><br>
	<div>
		<span>关键字</span>
		<input type="text" name="keywords" value="${media.keywords}">
	</div><br>
	<div>
	...
	<div>
	<input type="submit" value="更新书籍" onclick="checkInputIsEmpty();">&nbsp;	&nbsp;<input type="reset" value="取消">
	</div>
</form>
