...
;window.Swipe = function(element, options) {
  ...
  this.verticalAlign= this.options.verticalAlign || 'top';
...
Swipe.prototype = {
  ...
  setup: function() {
    ...
    while (index--) {
	  ...
	  el.style.height = this.width*1 + 'px';
  ...
  onTouchEnd: function(e) {
    ...
    var isValidSlide = 
          ...
          || Math.abs(this.deltaX) > this.width/5,        // or if slide amt is greater than half the width
